...
<div class="table-responsive p-3">
    ...
    <tr class="text-center">
        ...
        <th>Catatan Disposisi</th> <!-- Tambahkan kolom Catatan Disposisi -->
    </tr>
</thead>
<tbody>
    <?php
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td class='action-buttons'>
                ...
                <button class='btn btn-success btn-sm' onclick='showConfirmAccModal(\"$idsm\")'>Sudah Ditanggapi</button>
                </td>";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmAccModalLabel">Konfirmasi Disposisi</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="mb-3">
                    <label for="pelaksanaInput" class="form-label">Pelaksana</label>
                    <input type="text" class="form-control" id="pelaksanaInput" placeholder="Masukkan nama pelaksana">
                </div>
...
document.getElementById('confirmAccButton').addEventListener('click', function() {
    if (currentAccId) {
        var pelaksana = document.getElementById('pelaksanaInput').value; // Ambil nama pelaksana
        updateStatus("Acc", currentAccId, pelaksana); // Mengirimkan nama pelaksana ke server
...
function updateStatus(status, idsm, pelaksana) {
    // Kirim AJAX request untuk update status dan pelaksana
    $.ajax({
        ...
        data: { 
            status: status, 
            idsm: idsm, 
            pelaksana: pelaksana // Kirim nama pelaksana
        },
